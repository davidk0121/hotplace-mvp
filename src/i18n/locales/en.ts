...
export const en = {
  ...
  home: {
    title: "Save a place",
    subtitle: "Paste anything — a reel, a map link, or just a name.",
    recentTitle: "Recently saved",
    recentSeeAll: "See all",
    listsTitle: "Your lists",
    listsSeeAll: "See all",
    listsEmpty: "Group your saved places into lists — trips, date spots, cafes.",
    makeList: "+ New list",
  },
  quickSave: {
    placeholder: "Paste a reel, map link, or place name",
    hint: "Paste anything — we'll help you organize it.",
    start: "Save",
    savedTitle: "Saved!",
    addToList: "Add to a list",
    makeList: "Make a list",
    saveAnother: "Save another",
    viewPlaces: "View my places",
  },
  nearby: {
    title: "Explore nearby",
    subtitle: "Discover spots and save the ones you like.",
