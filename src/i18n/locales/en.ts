...
export const en = {
  ...
  form: {
    ...
    locationHint: "Pick a location to drop a real pin — or save without it.",
    findLocation: "🔍 Find location",
    searching: "Searching…",
    noResults: "No matches — you can save without location.",
  ...
  quickSave: {
    ...
    savedNoLocTitle: "Saved without location",
    savedNoLocBody: "Add a location to show it as a pin on the map.",
