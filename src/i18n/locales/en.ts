...
export const en = {
  ...
  places: {
    title: "Places",
    subtitle: "Every place on your Korea map, by category.",
    add: "+ Add place",
  ...
  home: {
    title: "Build your Korea map",
    subtitle:
      "Save every place you find — Reels, TikTok, map links, recommendations — into one map.",
    mapTitle: "Your Korea map",
  ...
  quickSave: {
    placeholder:
      "Paste a Reel, TikTok, Naver / Kakao / Google / Apple Maps link — or a place name",
    hint: "Found a place on Reels or a map app? Paste it here.",
    start: "Save",
    detectedFrom: "From",
    savedTitle: "Saved to your Korea map",
  ...
  map: {
    ...
    empty: "No pins yet — save your first Korea place above.",
    openIn: "Open in",
    remove: "Remove",
  ...
  nearby: {
    title: "Explore Korea",
    subtitle: "Popular spots by area — tap Save to add them to your map.",
    useLocation: "📍 Use my location",
    locating: "Getting your location…",
    denied: "Location off — pick an area instead.",
    nearYou: "Popular near you",
    chooseArea: "Or choose an area",
    save: "Save",
    saved: "Saved ✓",
  },
  areas: {
  ...
  onboarding: {
    title: "One map for every Korea place you want to try",
    steps: [
      {
        emoji: "🔗",
        title: "Paste",
        desc: "A Reel, TikTok, or map link — or just a place name.",
      },
      {
        emoji: "📍",
        title: "Map it",
        desc: "Every place lands on your personal Korea map.",
      },
      {
        emoji: "🗂️",
        title: "Collect",
