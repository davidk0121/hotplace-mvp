...
export const ko: Dictionary = {
  ...
  places: {
    title: "장소",
    subtitle: "내 한국 지도에 저장된 모든 장소를 카테고리별로.",
    add: "+ 장소 추가",
    addFirst: "+ 장소 추가하기",
    all: "전체",
    emptyNone:
  ...
  home: {
    title: "내 한국 지도 만들기",
    subtitle:
      "릴스·틱톡·지도 링크·추천 — 발견한 모든 장소를 한 지도에 모아두세요.",
    mapTitle: "내 한국 지도",
  ...
  quickSave: {
    placeholder:
      "릴스·틱톡·네이버/카카오/구글/애플 지도 링크 — 또는 장소 이름 붙여넣기",
    hint: "릴스나 지도 앱에서 본 장소, 여기에 붙여넣으세요.",
    start: "저장",
    detectedFrom: "출처",
    savedTitle: "내 한국 지도에 저장했어요",
  ...
  map: {
    ...
    empty: "아직 핀이 없어요 — 위에서 첫 장소를 저장해보세요.",
    openIn: "지도 열기",
    remove: "빼기",
  ...
  nearby: {
    title: "한국 둘러보기",
    subtitle: "지역별 인기 장소 — Save를 눌러 내 지도에 추가하세요.",
    useLocation: "📍 내 위치 사용",
    locating: "위치를 가져오는 중…",
  ...
  onboarding: {
    title: "한국에서 가보고 싶은 장소를 한 지도에",
    steps: [
      {
        emoji: "🔗",
        title: "붙여넣기",
        desc: "릴스·틱톡·지도 링크, 아니면 그냥 장소 이름.",
      },
      {
        emoji: "📍",
        title: "지도에",
        desc: "저장한 장소가 내 한국 지도에 핀으로 찍혀요.",
      },
      {
        emoji: "🗂️",
        title: "컬렉션",
